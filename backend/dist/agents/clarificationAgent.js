...
async function clarificationAgent(input) {
    (0, logger_1.debug)('clarificationAgent', { input });
    try {
        ...
        (0, logger_1.debug)('clarificationAgent:completion', { completion });
        let content = completion.choices?.[0]?.message?.content || '{}';
        (0, logger_1.debug)('LLM_RAW_CONTENT_CLARIFICATION', { content });
        ...
        if (!jsonMatch) {
            (0, logger_1.error)('clarificationAgent:no-json', { content });
        ...
        try {
            ...
            (0, logger_1.error)('clarificationAgent:parse-error', { e, content: jsonMatch[0] });
        ...
        (0, logger_1.error)('clarificationAgent', err);
        throw err;
    }
}
