...
export async function deployToVercel({ buildDir = '../../frontend/dist', projectName = 'ai-coding-agent-iota-ochre', meta }: DeployToVercelOptions = {}): Promise<DeployToVercelResult> {
